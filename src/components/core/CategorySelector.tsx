...
import { CATEGORIES, getCategoriesWithWordCount, type Category } from '@/constants/wordBank';
...
const CategorySelector = ({ selectedCategory, onCategoryChange, onContinue, onBack, className = '' }: CategorySelectorProps) => {
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    text-center hover:scale-105 hover:shadow-md
                    ${colorClasses}
                  `}
                >
          ...
          <div className="text-center mb-4">
            <div className="inline-flex items-center px-4 py-2 bg-slate-100 rounded-lg">
              <span className="text-2xl mr-2">{CATEGORIES[selectedCategory].icon}</span>
              <span className="text-slate-700 font-medium">{CATEGORIES[selectedCategory].name}</span>
          ...
          <div className="text-center">
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-cyan-400 hover:from-blue-600 hover:to-cyan-500 
                         text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl
